...
def main(argv):
    ...
    with tf.Graph().as_default() as graph:
        ...
        if flags.freeze:
            ...
            utils.freeze_graph(sess, './checkpoint/yolov3_cpu_nms_bdd.pb', cpu_out_node_names)
            utils.freeze_graph(sess, './checkpoint/yolov3_gpu_nms_bdd.pb', gpu_out_node_names)
